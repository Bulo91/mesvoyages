...
class VoyagesControllerTest extends WebTestCase{
    ...
    public function testContenuPage(){
        ...
        $this->assertSelectorTextContains('h5', 'Alabasta'); 
    }
    ...
    public function testLinkVille(){
        ...
        $this->assertEquals('/voyages/voyage/201', $uri);
    }
